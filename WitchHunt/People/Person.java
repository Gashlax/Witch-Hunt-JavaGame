...
public class Person implements Person_Interface {
	...
	final int whoIsWitch = Driver.witchIndex;
	...
	Items Cat = new WitchItems("Cat","It is just good looking regular black cat but it looks so sinfully. It's frightening");
